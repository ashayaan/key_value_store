...
class TestDataStore(unittest.TestCase):
    ...
    @unittest.skipIf(threading.Lock not in sys.modules, "threading.Lock not found")
    def test_put_and_get(self):
        self.data_store.put("X", "10", "thread1")
        self.assertEqual(self.data_store.get("X"), "10")

    def test_delete(self):
        self.data_store.put("X", "10", "thread1")
        self.assertEqual(self.data_store.delete("X", "10"), "SUCCESS")
        self.assertIsNone(self.data_store.get("X"))
